...
const file_pb_pubsub_proto_rawDesc = "" +
	"\n" +
	"\x0fpb/pubsub.proto\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\aPublish\x12\x0f.PublishRequest\x1a\x16.google.protobuf.EmptyB\x03Z\x01.b\x06proto3"

var (
	file_pb_pubsub_proto_rawDescOnce sync.Once
	file_pb_pubsub_proto_rawDescData []byte
)

func file_pb_pubsub_proto_rawDescGZIP() []byte {
	file_pb_pubsub_proto_rawDescOnce.Do(func() {
		file_pb_pubsub_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pb_pubsub_proto_rawDesc), len(file_pb_pubsub_proto_rawDesc)))
	})
	return file_pb_pubsub_proto_rawDescData
}

var file_pb_pubsub_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pb_pubsub_proto_goTypes = []any{
...
func file_pb_pubsub_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pb_pubsub_proto_rawDesc), len(file_pb_pubsub_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
